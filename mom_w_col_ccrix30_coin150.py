...
for j in js:
    for h in hs:
        ...
        #     'results/traditional_150/trad_cumulated_ret/df_group_return'+'_j_'+str(j) + '_h_' + str(h) + '_mean_' + str(
        #         np.round(ave_trad_mon, 4)) + '_t_' + str(np.round(t_stats_trad_com, 4)) + '.csv')
        # df_coin_selected_trad.to_csv(
        #     'results/traditional_150/trad_cumulated_ret/df_stk_selected'+'_j_'+str(j) + '_h_' + str(h) + '_mean_' + str(
        #         np.round(ave_trad_mon, 4)) + '_t_' + str(np.round(t_stats_trad_com, 4)) + '.csv')

df_t_stats_trad_jk.to_csv('150_coins_trad_5groups_jk_lb_' + str(lb) + '_simplecumulated_mom（去除异常收益率）.csv')
...
for k in ks:  # 上溯天数
    ...
    for h in hs:
        ...
        #     'results/traditional_150/mv/df_group_return_k_' + str(k) + '_h_' + str(h) + '_mean_' + str(
        #         np.round(ave_mon_trad_mv, 4)) + '_t_' + str(np.round(t_trad_com_mv, 4)) + '.csv')
        # df_coin_selected_trad_mv.to_csv(
        #     'results/traditional_150/mv/df_stk_selected_k_' + str(k) + '_h_' + str(h) + '_mean_' + str(
        #         np.round(ave_mon_trad_mv, 4)) + '_t_' + str(np.round(t_trad_com_mv, 4)) + '.csv')
        ...
        #     'results/traditional_150/mv2/df_group_return_k_' + str(k) + '_h_' + str(h) + '_mean_' + str(
        #         np.round(ave_mon_trad_mv2, 4)) + '_t_' + str(np.round(t_trad_com_mv2, 4)) + '.csv')
        # df_coin_selected_trad_mv2.to_csv(
        #     'results/traditional_150/mv2/df_stk_selected_k_' + str(k) + '_h_' + str(h) + '_mean_' + str(
        #         np.round(ave_mon_trad_mv2, 4)) + '_t_' + str(np.round(t_trad_com_mv2, 4)) + '.csv')

# df_t_stats_trad_excessret.to_csv('150_coins_test_trad_excessret_lb_' + str(lb) + '_k_short_h.csv')
df_t_stats_trad_mv.to_csv('150_coins_test_trad_lb_' + str(lb) + 'k_long_h_mv(去除异常收益）.csv')
df_t_stats_trad_mv2.to_csv('150_coins_test_trad_lb_' + str(lb) + 'k_long_h_mv2（去除异常收益）.csv')
